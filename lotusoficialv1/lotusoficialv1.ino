...
void segue_faixa() {
  ...
  while (digitalRead(se) == 1 && digitalRead(sce) == 0 && digitalRead(sf) == 1 && digitalRead(scd) == 1 && digitalRead(sd) == 1) {
    while (digitalRead(scd) == 1) {
      esquerda(250, 250);
    }
  }
  //giro direito central curto
  while (digitalRead(se) == 1 && digitalRead(sce) == 1 && digitalRead(sf) == 1 && analogRead(scd) == 0 && digitalRead(sd) == 1) {
    while (digitalRead(sce) == 1) {
      direita(250, 250);
    }
  }
  //giro direita externo
   if (digitalRead(se) == 1 && digitalRead(sce) == 1 && digitalRead(sf) == 1 && digitalRead(scd) == 1 && digitalRead(sd) == 0) {
    para(100);
    frente(150, 150);
    delay(300);
  ...
  else if (digitalRead(se) == 0 && digitalRead(sce) == 1 && digitalRead(sf) == 1 && digitalRead(scd) == 1 && digitalRead(sd) == 1) {
    para(100);
    frente(150, 150);
    delay(300);
    while (digitalRead(sf) == 1) {
  ...
  //giro 90 esquerda
  else if (digitalRead(se) == 0 && digitalRead(sce) == 0 && digitalRead(sf) == 0 && digitalRead(scd) == 0 && digitalRead(sd) == 1) {
    para(100);
    digitalWrite(g, LOW);
    while(digitalRead(sf) == 0){
    frente(80,80);
  ...
  //esquerda curva
  else if (digitalRead(se) == 0 && digitalRead(sce) == 0 && digitalRead(sf) == 0 && digitalRead(scd) == 1 && digitalRead(sd) == 1) {
    para(2000);
    frente(150, 150);
    delay(200);
    while (digitalRead(sf) == 1) {
  ...
  //direita curva
  else if (digitalRead(se) == 1 && digitalRead(sce) == 1 && digitalRead(sf) == 0 && digitalRead(scd) == 0 && digitalRead(sd) == 0) {
    para(2000);
    frente(150, 150);
    delay(200);
    while (digitalRead(sf) == 1) {
